...
<div class="pusher">
    <div class="full height">
        <div class="zoomed masthead segment fund w3-display-container" style="height: 300px;">
            <h2 class="w3-center w3-display-middle w3-margin-top">Novo <b class="logo">Beat</b></h2>
        ...
        <div class="feature alternate ui stripe vertical segment">
            <form action="/add/beat" method="POST" class="ui form w3-container w3-center w3-margin-top">
                <div class="ui container middle aligned column ">
                    ...
                    <div class="w3-hide">
                        ...
                        <input name="produtora" type="hidden" class="w3-hide">
