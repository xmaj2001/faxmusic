            ...
            <form method="POST" class="ui form w3-container w3-center w3-margin-top">
                <div class="ui container middle aligned column ">
                    ...
                    <div class="wide field w3-margin-top ui icon input">
                        ...
                        <input name="produtora" type="text" class="w3-border-0 w3-border-bottom w3-transparent" value="<?php echo $produtora ?>" placeholder="Produtora" required>
                    </div>

                    <div class="wide field w3-margin-top ui icon input">
                        <i class="circle icon"></i>
                        <input name="genero" type="text" class="w3-border-0 w3-border-bottom w3-transparent" value="<?php echo $genero ?>" placeholder="Género" required>
                    </div>
