...
<div class="pusher">
    <div class="full height">
        <div class="zoomed masthead segment fund w3-display-container" style="height: 300px;">
            <h2 class="w3-center w3-display-middle w3-margin-top">Nova <b class="logo">Musica</b></h2>
        ...
        <div class="feature alternate ui stripe vertical segment">
            <form method="POST" class="ui form w3-container w3-center w3-margin-top">
                <div class="ui container middle aligned column ">
                    ...
                    <div class="wide field w3-margin-top ui icon input">
                        <i class="user icon"></i>
                        <input name="autor" type="text" class="w3-border-0 w3-border-bottom w3-transparent" placeholder="Artista" required>
                    </div>

                    <div class="wide field w3-margin-top ui icon input">
                        <i class="sliders horizontal icon"></i>
                        <input name="produtora" type="text" class="w3-border-0 w3-border-bottom w3-transparent" placeholder="Produtora" required>
                    </div>

                    <div class="wide field w3-margin-top ui icon input">
                        <i class="circle icon"></i>
                        <input name="genero" type="text" class="w3-border-0 w3-border-bottom w3-transparent" placeholder="Género" required>
                    </div>
